        ...
        <div class="info-content">
            ...
            <div class="slideshow-container">
                <div class="slide fade">
                    <img src="${pageContext.request.contextPath}/img/dalat.jpg" alt="Tour Đà Lạt">
                    <div class="slide-caption">Tour Du lịch Đà Lạt</div>
                </div>
                <div class="slide fade">
                    <img src="${pageContext.request.contextPath}/img/phuquoc.jpg" alt="Tour Phú Quốc">
                    <div class="slide-caption">Tour Du lịch Phú Quốc</div>
                </div>
                <div class="slide fade">
                    <img src="${pageContext.request.contextPath}/img/sapa.jpg" alt="Tour Sapa">
