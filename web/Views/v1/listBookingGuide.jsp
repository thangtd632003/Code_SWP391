...
<body>
    ...
    <div style="margin-top:60px;">
        ...
        <div class="controls">
            <form method="get" action="${pageContext.request.contextPath}/ListBookingGuide_servlet">
                <input type="text"
                       name="keyword"
        ...
        <table id="bookingTable">
            <thead>
                <tr>
                    ...
                    >
                      <a href="<c:url value='/ListBookingGuide_servlet'>
            ...
            <tbody>
                <c:forEach var="b" items="${bookings}">
                    <tr>
                        ...
                        <td>
                            <!-- Nút Detail -->
                            <form method="post" action="${pageContext.request.contextPath}/ListBookingGuide_servlet">
