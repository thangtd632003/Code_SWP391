...
<body>
  ...
  <div style="margin-top:60px;">
    ...
    <div class="controls">
      ...
      <div>
        <button onclick="location.href='${pageContext.request.contextPath}/createTour_servlet'">
          + Add New Tour
        </button>
      </div>
    </div>
    ...
    <table id="tourTable">
      <thead>
        <tr>
          ...
          >
            <a href="<c:url value='/tourList_servlet'>
            ...
            <td>
              <button class="action-btn"
                ...
                Update
                 ...
                 <button class="action-btn"
                      onclick="location.href='${pageContext.request.contextPath}/detailTourGuide_servlet?id=${t.id}'">
                Detail
              </button>
              <button class="action-btn"
                      onclick="if(confirm('Are you sure to update status tour #${t.id}?')) {
                                 ...
                                 form.method = 'post';
                                 form.action = '${pageContext.request.contextPath}/tourList_servlet';
