 ...
 * @author thang
 */
public class createBooking_thang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet createBooking_thang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet createBooking_thang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       HttpSession session = request.getSession(false);
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            Logger.getLogger(createBooking_thang.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        request.getRequestDispatcher("/Views/thang/bookingTour.jsp")
    ...
    throws ServletException, IOException {
      HttpSession session = request.getSession(false);
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/createBooking_thang?tourId=" 
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            if (sameDateConflict) {
                ...
                response.sendRedirect(request.getContextPath() 
                        + "/createBooking_thang?tourId=" + tourId 
                        + "&message=" + m);
                return;
            }
        ...
        response.sendRedirect(request.getContextPath() + "/createBooking_thang?tourId=" + tourId+"&message=bookingSuccess");
    }
