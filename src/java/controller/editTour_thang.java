 ...
 * @author thang
 */
public class editTour_thang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet editTour_thang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet editTour_thang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            request.getRequestDispatcher("/Views/thang/editTour.jsp").forward(request, response);
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(editTour_thang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    throws ServletException, IOException {
        ...
        String redirectUrl = String.format("%s/editTour_thang?id=%s&update=%s", 
