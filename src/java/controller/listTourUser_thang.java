 ...
 * @author thang
 */
public class listTourUser_thang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listTourUser_thang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listTourUser_thang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            request.getRequestDispatcher("/Views/thang/listTourUser.jsp")
    ...
    throws ServletException, IOException {
        ...
        if ("detail".equalsIgnoreCase(action)) {
            ...
            response.sendRedirect(request.getContextPath() + "/createBooking_thang?tourId=" + tourId);
        }
        else {
            response.sendRedirect(request.getContextPath() + "/listTourUser_thang");
        }
