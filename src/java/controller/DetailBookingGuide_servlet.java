 ...
 * @author thang
 */
public class DetailBookingGuide_servlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailBookingGuide_servlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailBookingGuide_servlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
      ...
      HttpSession session = request.getSession(false);
        ...
        try {
         ...
         User userTravelerInfo= userDao.getUserById(booking.getTravelerId());
            ...
            request.getRequestDispatcher("/Views/v1/bookingDetailGuide.jsp")
