 ...
 * @author thang
 */
public class ForgotPassword_thang extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ForgotPassword_thang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ForgotPassword_thang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
      HttpSession session = request.getSession(false);
        ...
        request.getRequestDispatcher("/Views/thang/forgotPassword.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
       HttpSession session = request.getSession(false);
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            response.sendRedirect(request.getContextPath() + "/ChangePassword_thang");
        } catch (Exception e) {
            e.printStackTrace();
