...
@Override
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailBookingTraveler_thang</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailBookingTraveler_thang at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (action == null) {
            String bookingIdParam = request.getParameter("bookingId");
            response.sendRedirect(request.getContextPath() + "/DetailBookingTraveler_thang?bookingId=" + bookingIdParam);
            return;
        }
        ...
        switch (action) {
            case "changeStatus":
                ...
                response.sendRedirect(request.getContextPath() + "/DetailBookingTraveler_thang?bookingId=" + bid);
                break;
